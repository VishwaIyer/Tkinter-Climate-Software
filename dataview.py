...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        forground=[('pressed','red'),('active','green')],
    ...
    def show_graph(self):
        regression_plot(self.efname.ge(),self.eXget(),self.eY.get())

    def show_stats(self):
        x_stats,ystats= stats_columns(self.eFname.get(),self.eX.get(),self.eY.get())
